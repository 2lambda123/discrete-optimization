...
class RCPSPModelPreemptive(Problem):
    ...
    def get_modes_dict(self, rcpsp_solution: RCPSPSolutionPreemptive):
    ...
    def compute_resource_consumption(self, rcpsp_sol: RCPSPSolutionPreemptive):
    ...
    def plot_ressource_view(self, rcpsp_sol: RCPSPSolutionPreemptive):
...
def generate_schedule_from_permutation_serial_sgs(
    solution: RCPSPSolutionPreemptive, rcpsp_problem: RCPSPModelPreemptive
):
    activity_end_times = {}
...
def get_rcpsp_modelp_preemptive(rcpsp_model):
    return RCPSPModelPreemptive(
        ...
        preemptive_indicator={
            rcpsp_model.tasks_list[k]: True for k in range(rcpsp_model.n_jobs)
        },
